...
; 
	ldaa #0xd0
	staa 0xa079	; put in stack to be pulled
; 
; initialize acia 
; 
...
opbttb:
	.byte 1	; 0
	.byte 1	; 1
	.byte 2+%10000000	; 2 ( minus=> branches )
	.byte 1	; 3
	.byte 1	; 4
	.byte 1	; 5
	.byte 2	; 6
...
brins:	.space 8	; storage for conditional branch
; routine 
branen:		; end of branch routine + 1
; 
...
; breakpoint restored 
	.equ endin0, 0xa080	; end of var's intz' d to 0
; 
...
; 
	.space 36
stack:	.space 1	; start of stack area
