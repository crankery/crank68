...
public:
    ...
    typedef bool (M6800::*MethodPtr)(uint8_t opcode, op_names op, addr_mode mode);
    ...
    M6800()
    {
        operations[op_names::lds] = &M6800::op_lds;
    }
...
private:
    ...
    std::array<MethodPtr, 256> operations{};
};
